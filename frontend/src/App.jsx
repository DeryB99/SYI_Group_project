  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'Arial' }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <p><strong>Total Revenue:</strong> ${Number(stats.totalRevenue).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        <p><strong>Average Price:</strong> ${stats.averagePrice.toFixed(2)}</p>
        <p><strong>Top Category:</strong> {stats.topCategory}</p>
      </div>
